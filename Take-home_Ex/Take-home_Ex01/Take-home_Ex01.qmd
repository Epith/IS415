...
```{r}
pacman::p_load(sf, raster, spatstat, tmap, tidyverse,sparr,sp, splancs)
```
...
```{r}
acled_ppp_battles_2021 <- acled_sf %>% filter(event_type == "Battles", year == 2021 ) %>% {as.ppp(st_coordinates(.),st_bbox(.))}
acled_ppp_battles_2022 <- acled_sf %>% filter(event_type == "Battles", year == 2022 ) %>% {as.ppp(st_coordinates(.),st_bbox(.))}
acled_ppp_battles_2023 <- acled_sf %>% filter(event_type == "Battles", year == 2023 ) %>% {as.ppp(st_coordinates(.),st_bbox(.))}
acled_ppp_battles_2024 <- acled_sf %>% filter(event_type == "Battles", year == 2024 ) %>% {as.ppp(st_coordinates(.),st_bbox(.))}

acled_ppp_explosion_2021 <- acled_sf %>% filter(event_type == "Explosions/Remote violence", year == 2021) %>% {as.ppp(st_coordinates(.),st_bbox(.))}
acled_ppp_explosion_2022 <- acled_sf %>% filter(event_type == "Explosions/Remote violence", year == 2022) %>% {as.ppp(st_coordinates(.),st_bbox(.))}
acled_ppp_explosion_2023 <- acled_sf %>% filter(event_type == "Explosions/Remote violence", year == 2023) %>% {as.ppp(st_coordinates(.),st_bbox(.))}
acled_ppp_explosion_2024 <- acled_sf %>% filter(event_type == "Explosions/Remote violence", year == 2024) %>% {as.ppp(st_coordinates(.),st_bbox(.))}

acled_ppp_strat_2021 <- acled_sf %>% filter(event_type == "Strategic developments", year == 2021) %>% {as.ppp(st_coordinates(.),st_bbox(.))}
acled_ppp_strat_2022 <- acled_sf %>% filter(event_type == "Strategic developments", year == 2022) %>% {as.ppp(st_coordinates(.),st_bbox(.))}
acled_ppp_strat_2023 <- acled_sf %>% filter(event_type == "Strategic developments", year == 2023) %>% {as.ppp(st_coordinates(.),st_bbox(.))}
acled_ppp_strat_2024 <- acled_sf %>% filter(event_type == "Strategic developments", year == 2024) %>% {as.ppp(st_coordinates(.),st_bbox(.))}

acled_ppp_violence_2021 <- acled_sf %>% filter(event_type == "Violence against civilians", year == 2021) %>% {as.ppp(st_coordinates(.),st_bbox(.))}
acled_ppp_violence_2022 <- acled_sf %>% filter(event_type == "Violence against civilians", year == 2022) %>% {as.ppp(st_coordinates(.),st_bbox(.))}
acled_ppp_violence_2023 <- acled_sf %>% filter(event_type == "Violence against civilians", year == 2023) %>% {as.ppp(st_coordinates(.),st_bbox(.))}
acled_ppp_violence_2024 <- acled_sf %>% filter(event_type == "Violence against civilians", year == 2024) %>% {as.ppp(st_coordinates(.),st_bbox(.))}
```
